...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO payments(payment_id, contribution_id, payment_method, amount) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("iisd", $payment_id, $contribution_id, $payment_method, $amount);
